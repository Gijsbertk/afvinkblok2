...
class gui:
    """deze maak een de frame klaar met een eindstreep plut een stop knop"""
    def __init__(self):
    ...
    """deze functie zorgt ervoor dat er de lijn elke keer willekeurige nummers krijgt toebedeeld"""
    def plaatje(self):
        a = int(0)
        b = int(0)
        c = int(0)
